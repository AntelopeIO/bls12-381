...
public:
    ...
    fp(const fp& e);
    static fp fromBytesBE(const std::span<const uint8_t, 48> in, const bool check = false, const bool raw = false);
    static fp fromBytesLE(const std::span<const uint8_t, 48> in, const bool check = false, const bool raw = false);
...
public:
    ...
    fp2(const fp2& e);
    static fp2 fromBytesBE(const std::span<const uint8_t, 96> in, const bool check = false, const bool raw = false);
    static fp2 fromBytesLE(const std::span<const uint8_t, 96> in, const bool check = false, const bool raw = false);
...
public:
    ...
    fp6(const fp6& e);
    static fp6 fromBytesBE(const std::span<const uint8_t, 288> in, const bool check = false, const bool raw = false);
    static fp6 fromBytesLE(const std::span<const uint8_t, 288> in, const bool check = false, const bool raw = false);
...
public:
    ...
    fp12(const fp12& e);
    static fp12 fromBytesBE(const std::span<const uint8_t, 576> in, const bool check = false, const bool raw = false);
    static fp12 fromBytesLE(const std::span<const uint8_t, 576> in, const bool check = false, const bool raw = false);

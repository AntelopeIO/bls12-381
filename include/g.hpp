...
public:
    ...
    g1(const g1& e);
    static g1 fromJacobianBytesBE(const std::span<const uint8_t, 144> in, const bool check = false);
    static g1 fromJacobianBytesLE(const std::span<const uint8_t, 144> in, const bool check = false);
    static g1 fromAffineBytesBE(const std::span<const uint8_t, 96> in, const bool check = false);
    static g1 fromAffineBytesLE(const std::span<const uint8_t, 96> in, const bool check = false);
    static g1 fromCompressedBytesBE(const std::span<const uint8_t, 48> in);
    void toJacobianBytesBE(const std::span<uint8_t, 144> out) const;
    void toJacobianBytesLE(const std::span<uint8_t, 144> out) const;
    void toAffineBytesBE(const std::span<uint8_t, 96> out) const;
    void toAffineBytesLE(const std::span<uint8_t, 96> out) const;
    void toCompressedBytesBE(const std::span<uint8_t, 48> out) const;
    std::array<uint8_t, 144> toJacobianBytesBE() const;
    std::array<uint8_t, 144> toJacobianBytesLE() const;
    std::array<uint8_t, 96> toAffineBytesBE() const;
    std::array<uint8_t, 96> toAffineBytesLE() const;
...
public:
    ...
    g2(const g2& e);
    static g2 fromJacobianBytesBE(const std::span<const uint8_t, 288> in, const bool check = false);
    static g2 fromJacobianBytesLE(const std::span<const uint8_t, 288> in, const bool check = false);
    static g2 fromAffineBytesBE(const std::span<const uint8_t, 192> in, const bool check = false);
    static g2 fromAffineBytesLE(const std::span<const uint8_t, 192> in, const bool check = false);
    static g2 fromCompressedBytesBE(const std::span<const uint8_t, 96> in);
    void toJacobianBytesBE(const std::span<uint8_t, 288> out) const;
    void toJacobianBytesLE(const std::span<uint8_t, 288> out) const;
    void toAffineBytesBE(const std::span<uint8_t, 192> out) const;
    void toAffineBytesLE(const std::span<uint8_t, 192> out) const;
    void toCompressedBytesBE(const std::span<uint8_t, 96> out) const;
    std::array<uint8_t, 288> toJacobianBytesBE() const;
    std::array<uint8_t, 288> toJacobianBytesLE() const;
    std::array<uint8_t, 192> toAffineBytesBE() const;
    std::array<uint8_t, 192> toAffineBytesLE() const;

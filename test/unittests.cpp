...
void TestFieldElementSerialization()
{
    ...
    }
    {
        ...
        {
            fp a = random_fe();
            fp b = fp::fromBytesBE(a.toBytesBE());
            if(!a.equal(b))
            {
        ...
        {
            fp a = random_fe();
            fp b = fp::fromBytesLE(a.toBytesLE());
            if(!a.equal(b))
            {
    ...
    }
    {
        ...
        {
            fp a = random_fe();
            fp b = fp::fromBytesBE(hexToBytes<48>(bytesToHex<48>(a.toBytesBE())));
            if(!a.equal(b))
            {
                throw invalid_argument("string, BE: bad encoding or decoding");
            }
            b = fp::fromBytesLE(hexToBytes<48>(bytesToHex<48>(a.toBytesLE())));
            if(!a.equal(b))
            {
...
void TestG1Serialization()
{
    for(uint64_t i = 0; i < fuz; i++)
    {
        ...
        g1 b = g1::fromJacobianBytesBE(buf);
        if(!a.equal(b))
        {
    ...
    for(uint64_t i = 0; i < fuz; i++)
    {
        ...
        g1 b = g1::fromCompressedBytesBE(buf);
        if(!a.equal(b))
        {
...
void TestG1MapToCurve()
{
    ...
    array<pair, 5> pairs = {
        pair{
            ...
            g1({fp::fromBytesBE(hexToBytes<48>("11a9a0372b8f332d5c30de9ad14e50372a73fa4c45d5f2fa5097f2d6fb93bcac592f2e1711ac43db0519870c7d0ea415")), fp::fromBytesBE(hexToBytes<48>("092c0f994164a0719f51c24ba3788de240ff926b55f58c445116e8bc6a47cd63392fd4e8e22bdf9feaa96ee773222133")), fp::one()})
        },
        pair{
            ...
            g1({fp::fromBytesBE(hexToBytes<48>("1223effdbb2d38152495a864d78eee14cb0992d89a241707abb03819a91a6d2fd65854ab9a69e9aacb0cbebfd490732c")), fp::fromBytesBE(hexToBytes<48>("0f925d61e0b235ecd945cbf0309291878df0d06e5d80d6b84aa4ff3e00633b26f9a7cb3523ef737d90e6d71e8b98b2d5")), fp::one()})
        },
        pair{
            ...
            g1({fp::fromBytesBE(hexToBytes<48>("179d3fd0b4fb1da43aad06cea1fb3f828806ddb1b1fa9424b1e3944dfdbab6e763c42636404017da03099af0dcca0fd6")), fp::fromBytesBE(hexToBytes<48>("0d037cb1c6d495c0f5f22b061d23f1be3d7fe64d3c6820cfcd99b6b36fa69f7b4c1f4addba2ae7aa46fb25901ab483e4")), fp::one()})
        },
        pair{
            ...
            g1({fp::fromBytesBE(hexToBytes<48>("15aa66c77eded1209db694e8b1ba49daf8b686733afaa7b68c683d0b01788dfb0617a2e2d04c0856db4981921d3004af")), fp::fromBytesBE(hexToBytes<48>("0952bb2f61739dd1d201dd0a79d74cda3285403d47655ee886afe860593a8a4e51c5b77a22d2133e3a4280eaaaa8b788")), fp::one()})
        },
        pair{
            ...
            g1({fp::fromBytesBE(hexToBytes<48>("06328ce5106e837935e8da84bd9af473422e62492930aa5f460369baad9545defa468d9399854c23a75495d2a80487ee")), fp::fromBytesBE(hexToBytes<48>("094bfdfe3e552447433b5a00967498a3f1314b86ce7a7164c8a8f4131f99333b30a574607e301d5f774172c627fd0bca")), fp::one()})
        },
    };
...
void TestG2Serialization()
{
    for(uint64_t i = 0; i < fuz; i++)
    {
        ...
        g2 b = g2::fromJacobianBytesBE(buf);
        if(!a.equal(b))
        {
            throw invalid_argument("g1, jacobian: bad serialization from/to");
        }
    ...
    for(uint64_t i = 0; i < fuz; i++)
    {
        ...
        g2 b = g2::fromCompressedBytesBE(buf);
        if(!a.equal(b))
        {
            throw invalid_argument("g1, compressed: bad serialization from/to");
        }
...
void TestIETFVectors()
{
    ...
    g2 sig1 = g2::fromCompressedBytesBE(hexToBytes<96>(sig1BasicHex));
...
void TestSignatures()
{
    ...
    }
    {
        ...
        g1 pk2 = g1::fromAffineBytesBE(pkData);
        if(!pk1.equal(pk2)) throw invalid_argument("pk1 must equal pk2!");
        ...
        g2 sig2 = g2::fromAffineBytesBE(sigData);
        if(!sig1.equal(sig2)) throw invalid_argument("sig1 must equal sig2!");
